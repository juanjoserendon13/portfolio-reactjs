...
const SideBar = () => (
  ...
  >
    ...
    <a id="my-me" className={styles.item} href="#me" >
      <span className={styles.itemicon}><i className="fa fa-user" aria-hidden="true" /></span>
       Me
    </a>

    <a id="my-work" className={styles.item} href="#work">
      <span className={styles.itemicon}><i className="fa fa-code" aria-hidden="true" /></span>
       My Work
    </a>

    <a id="my-about" className={styles.item} href="#aboutme">
      <span className={styles.itemicon}><i className="fa fa-id-card-o" aria-hidden="true" /></span>
       About Me
    </a>

    <a id="my-contact" className={styles.item} href="#contact">
      <span className={styles.itemicon}><i className="fa fa-envelope-o" aria-hidden="true" /></span>
       Contact Me
    </a>
